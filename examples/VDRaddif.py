...
vdr1.addif(edge_id="edge-64", if_name="edge-64-interface0", ls_id="virtualwire-56", if_ip="172.16.101.1", if_mask="255.255.255.0", if_type="internal")
...
vdr1.addif_list(edge_id="edge-64", if_list=if_list)