...
vdr1.addif(edge_id="edge-76", if_name="edge-76-interface0", ls_id="virtualwire-61", if_ip="172.16.101.1", if_mask="255.255.255.0", if_type="uplink")
...
if_dict_int1 = {'if_name': 'edge-76-interface1',
                'ls_id': 'virtualwire-62',
                'if_ip': '172.16.102.1',
                'if_mask': '255.255.255.0',
                'if_type': 'internal'}

if_dict_int2 = {'if_name': 'edge-76-interface2',
...
vdr1.addif_list(edge_id="edge-76", if_list=if_list)