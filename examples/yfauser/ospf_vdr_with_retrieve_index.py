...
vdr_ipif_web = {'if_name': 'web-tier', 'ls_id': 'virtualwire-####',
                'if_ip': '172.16.102.1', 'if_mask': '255.255.255.0', 'if_type': 'internal'}
vdr_ipif_app = {'if_name': 'app-tier', 'ls_id': 'virtualwire-####',
                'if_ip': '172.16.103.1', 'if_mask': '255.255.255.0', 'if_type': 'internal'}
vdr_ipif_db =  {'if_name': 'db-tier', 'ls_id': 'virtualwire-####',
                'if_ip': '172.16.104.1', 'if_mask': '255.255.255.0', 'if_type': 'internal'}
vdr_ipif_admin1 = {'if_name': 'admin1-tier', 'ls_id': 'virtualwire-####',
                   'if_ip': '192.168.10.1', 'if_mask': '255.255.255.0', 'if_type': 'internal'}
vdr_ipif_admin2 = {'if_name': 'admin2-tier', 'ls_id': 'virtualwire-####',
                   'if_ip': '192.168.11.1', 'if_mask': '255.255.255.0', 'if_type': 'internal'}
vdr_ipif_transit = {'if_name': 'transit-net', 'ls_id': 'virtualwire-####',
...
vdr = s.distributedRouter.enable_OSPF('edge-######', vdr_router_id, vdr_protocol_address, vdr_forwarding_address, 
